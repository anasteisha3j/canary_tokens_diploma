...
class TokenGenerator:
    ...
    def __init__(
        ...
        _port = os.environ.get('PORT') or os.environ.get('FLASK_RUN_PORT') or '8080'
        try:
            int(_port)
        except ValueError:
            _port = '8080'
        _default_base = f'http://127.0.0.1:{_port}'
        base = public_base_url or os.environ.get('PUBLIC_BASE_URL') or _default_base
